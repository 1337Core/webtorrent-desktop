...
export const torrentCommandRequestSchema = z.strictObject({
  protocolVersion: protocolVersionSchema,
  requestId: requestIdSchema,
  command: z.literal('torrentCommand'),
  payload: z.strictObject({ operation: engineCommandSchema })
})

export const torrentCommandResultSchema = z.discriminatedUnion('ok', [
  z.strictObject({
    protocolVersion: protocolVersionSchema,
    requestId: requestIdSchema,
    ok: z.literal(true),
    value: engineCommandResultSchema
  }),
  z.strictObject({
    protocolVersion: protocolVersionSchema,
    requestId: requestIdSchema.nullable(),
